...
Table.prototype.createMesh = function() {
	...
	var geometry = new THREE.PlaneGeometry(TABLE_LEN_X, TABLE_LEN_Y);
	...
	var topWall = new THREE.Mesh(new THREE.PlaneGeometry(TABLE_LEN_Y, TABLE_WALL_HEIGHT), material);
	var bottomWall = new THREE.Mesh(new THREE.PlaneGeometry(TABLE_LEN_Y, TABLE_WALL_HEIGHT), material);
	...
	leftWall.position.set(0 , TABLE_WALL_HEIGHT / 2.0 , -TABLE_LEN_Y / 2.0);
	rightWall.position.set(0 , TABLE_WALL_HEIGHT / 2.0 , TABLE_LEN_Y / 2.0);
